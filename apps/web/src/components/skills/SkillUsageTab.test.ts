...
const empty: SkillUsageSummary = { retention_days: 90, total: 0, anonymous: 0, daily: [], agents: [], environments: [], identities: [], identities_truncated: false };
describe("reported usage", () => {
  it("does not equate missing reports with no usage", () => {
    ...
    expect(html).toContain("No activations reported");
    expect(html).toContain("Reporting can be disabled or unavailable");
  });
