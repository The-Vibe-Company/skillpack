...
export function buildSkillpackSkillPrompts(version: string): LocalSkillPrompts {
  const install = [
    ...
    "   Bootstrap installs the signed Windows/Linux/macOS runtime, registers verified skills and",
    "   merges hooks without replacing your existing hooks. Check the runtime result; a missing",
    "   release is distribution_unavailable, never a successful install. Codex hook trust remains",
    "   a host-level review in /hooks. Do not edit trust files or bypass that review.",
